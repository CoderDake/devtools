...
abstract class FlutterTestDriver {
  ...
  final io.Directory _projectFolder;
  ...
  Future<void> _setupProcess(
    ...
    _process = await processManager.start(
      ...
      environment: <String, String>{
        'FLUTTER_TEST': 'true',
        'FLUTTER_WEB': 'true',
        if (singleWidgetReloads) 'FLUTTER_SINGLE_WIDGET_RELOAD': 'true',
      },
    );
  ...
  Future<int> _killGracefully() async {
    ...
    await resume().timeout(defaultTimeout).catchError((Object e) {
  ...
  Future<void> _setupProcess(
    ...
    await () async {
      ...
      try {
        ...
        _currentRunningAppId = ((await started)['params']
...
class FlutterTestTestDriver extends FlutterTestDriver {
  ...
  Future<void> _setupProcess(
    ...
    if (withDebugger) {
      ...
      final String vmServiceHttpString =
          startedProcessParams['observatoryUri']! as String;
      _vmServiceWsUri =
  ...
  Future<void> waitForCompletion() async {
    ...
    final Future<Object> timeoutFuture = Future<Object>.delayed(defaultTimeout);
